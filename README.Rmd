...
**NOTE**: This is a large package (more than 50 MB) and will never be submitted to CRAN due to its size.
But you can use `drat` to install it. See the installation section below.
